...
public:
  MainWindow() {
    ...
    scroll_area->verticalScrollBar()->setStyleSheet("QScrollBar:vertical {width:
    20px;}"); scroll_area->setWidget(content);
    ...
    // Create a top-level stack layout--only one child widget will be shown at a
    // time
